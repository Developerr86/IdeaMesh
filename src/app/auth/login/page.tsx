  ...
  return (
    <div className="w-full max-w-sm">
      <div className="text-center mb-8">
        ...
        <p className="text-sm text-white/40">Sign in to continue to IdeaMesh</p>
      </div>
      ...
      <form onSubmit={handleLogin} className="space-y-3">
        ...
        <div className="flex justify-end">
          <Link
            ...
            className="text-xs text-white/40 hover:text-accent-purple transition-colors"
          >
            Forgot password?
          </Link>
        </div>
...
export default function LoginPage() {
  return (
    <Suspense fallback={<div className="w-7 h-7 rounded-full bg-surface-2 animate-pulse mx-auto" />}>
      <LoginForm />
    </Suspense>
  )
}
